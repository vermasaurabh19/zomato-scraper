...
top_restaurant <- cbind(title = title_html,
                    rating = rating_html,
                  votes = votes_html,
...
top_restaurant$title <- trimws(top_restaurant$title)
...
#Saving as output
write.csv(top_restaurant,'C:/Users/vermas22/Desktop/Consulting/Self Training/top restaurant.csv')
